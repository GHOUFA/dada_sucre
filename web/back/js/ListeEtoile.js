...
function CreateListeEtoile(idListe, nbEtoile){
	...
	for(i=1; i<=nbEtoile; i++){
		...
		renduListe += "<img onclick=\"change()\" id=\"staroff-" + idListe + "-" + i + "\" src=\"http://www.afritours.com.tn/back/img/etoilej2.png\" border=\"0\" title=\"" + i + "\" style=\"border-width: 0px; display: block;\">";
		renduListe += "<img onclick=\"change()\" id=\"staron-" + idListe + "-" + i + "\" src=\"http://www.afritours.com.tn/back/img/etoilej4.png\" border=\"0\" title=\"" + i + "\" style=\"border-width: 0px; display: none;\">";
		renduListe += "</a>";
		renduListe += "</li>";
	}
